...
- 19:40-20:10 **Discussion:** MMED research projects ([Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/)) 
...
- 15:30-16:50 **Computer session:** Model fitting ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
	* 16:50-17:10 (Tutorial wrapup by [Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 17:10-17:30 Issues arising (mini-feedback, content in general) ([Thumbi Mwangi]({{site.subdomainurl}}/team/mwangi/))
...
- Tutorial catch-up
- [Project preferences questionnaire](https://forms.gle/LvSbCukSD7WvK49o8) [due by 11:00 on Monday]
- [Tutorial review and mentoring sessions questionnaire](https://forms.gle/S1YGWA3279s9jMrT8) [due by 18:30 on Monday]
...
**Note:** Please complete the [tutorial review and mentoring sessions questionnaire](https://forms.gle/S1YGWA3279s9jMrT8) by 18:30 on Monday!
...
- 15:30-16:30 **Lecture:** Likelihood fitting and dynamic models II ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))
- 16:30-17:00 **Tutorial review:** Q&A on all tutorials to date ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) and all)
- 17:00-17:30 **Work session:** Group projects
...
- 15:30-15:45 **Summary and Discussion:** Data wrangling: Data management and cleaning ([Thumbi Mwangi]({{site.subdomainurl}}/team/mwangi/))
- 15:45-15:55 **Tutorial 5 Summary** ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
...
- 15:55-17:00 **Live Lecture:** Introduction to Monte Carlo Markov Chains (MCMC) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 17:00-17:30 **Work session:** Group projects
...
- 15:45-15:55 **Lab 6 Summary** ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))
- 15:55-16:10 **Summary and Discussion:** Faculty research presentation ([John Hargrove]({{site.subdomainurl}}/team/hargrove/))
- 16:10-17:30 **Work session:** Group projects and One-on-one mentoring sessions (cross-time zone)
...
- Tutorial catch-up, as needed
- Work on group project
    - **Finalize project presentations and upload to Teams (00_FinalPresentations folder) by 14:30**
- One-on-one mentoring sessions 
...
- 15:30-17:30 **Group project presentations** ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/))
