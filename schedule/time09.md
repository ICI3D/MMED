...
- 16:40-16:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
...
- 18:30-20:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 18:30-19:00 **Discussion:** Dynamical Fever ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
...
- 15:55-16:05 Lab 1 Summary ((bolton)) 
...
- 16:30-17:30 **Research Pitches II** (Moderator: [Becky Borchering]({{site.subdomainurl}}/team/borchering/)) 
...
- 16:15-16:30 **Organizational session:** Schedule and goals for the second week ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
- 16:30-17:15 **Computer session:** Introduction to GitHub (discussion and tutorial) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 17:15-17:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) or (reiner))
...
- 15:30-15:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/) or (reiner))
