...
- 23:30-01:00 **Tutorial:** Dynamical Fever - computer exercise and discussion ((pulliam), all faculty assisting) NOTE (40 + 10 group + 40)
	...
	```
- 01:00-01:30 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 20:30-21:30 **Research Pitches I** (Moderator: (dushoff)) NOTE JD willing to moderate?
...
- **Video lecture:** (Hidden) assumptions of simple ODE models ((pulliam))
- **Coding demonstration:** Introduction to model implementation ((vanschalkwyk))
...
- **For Track B**
    - **Video lecture:** Basic stochastic simulation models ((borchering))
...
- **Video lecture:** Impact of contact patterns, consequences of heterogeneity, and modeling options ((dushoff))
...
- 21:30-22:30 **Research Pitches II** (Moderator: (borchering)) NOTE RB willing to moderate?
...
- 00:40-01:10 **Discussion:** MMED research projects ((dushoff)) NOTE 30 mins
...
- 20:40-22:10 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
  * SHADOW (Tutorial wrapup by (dushoff)) - [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 22:10-22:30 TBD NOTE **TODO: fill hole** Model taxonomy??
...
- 22:15-22:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ((pulliam) or (reiner))
...
- 20:30-20:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ((dushoff) or (reiner))
- 20:45-20:55 **Lab 6 Summary** NOTE mentor? **TODO:** assignment
- 20:55-21:30 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
- 21:30-22:30 **Work session:** Group projects NOTE does it make sense to have these during interactive sessions? I think so...

#### Interactive session 7b


- 23:30-00:30 **Real-world example:** Faculty research lecture ((li))
- 00:30-01:30 Special topic sessions / group mentoring (TBD) NOTE **TODO** - what??? as requested by participants?
- SHADOW 01:30-02:00 Faculty meeting
...
- 20:30-20:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ((pearson))
- 20:45-20:55 **Lab 7 Summary** ((kassanjee))
- 20:55-21:05 **Lab 8 Summary** ((kassanjee))
- 21:05-21:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) NOTE Why I??
- 21:20-21:30 **Tutorial 5 Summary** ((dushoff))
...
- 20:45-21:00 **Summary and Discussion:** Faculty research presentation ((hargrove))
- 21:00-22:30 **Work session:** Group projects NOTE 90 mins REALLY?? **TODO** think we need at least 30 mins additional structured time...

#### Interactive session 9b


- 23:30-00:30 Special topic sessions / group mentoring (TBD) NOTE **TODO** - what??? as requested by participants? or faculty / guest lecture??
- 00:30-01:30 Special topic sessions / group mentoring (TBD) NOTE **TODO** - what??? as requested by participants?
- SHADOW 01:30-02:00 Faculty meeting
