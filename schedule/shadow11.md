...
- 20:30-22:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) NOTE (40 + 10 group + 40)
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 20:30-21:00 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 19:10–19:30 **_Parallel sessions_** NOTE **TODO: Track assignments**
