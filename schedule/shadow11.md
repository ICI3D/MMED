...
- 18:40-18:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ((borchering))
...
- 20:30-22:00 **Tutorial:** Dynamical Fever - computer exercise and discussion ((pulliam), all faculty assisting) NOTE (40 + 10 group + 40)
	...
	```
- 22:00-22:30 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 17:30-18:30 **Research Pitches I** (Moderator: (dushoff)) NOTE JD willing to moderate?
...
- 18:30-19:30 **Research Pitches II** (Moderator: (borchering)) NOTE RB willing to moderate?
...
- 21:40-22:10 **Discussion:** MMED research projects ((dushoff)) NOTE 30 mins
...
- 17:40-19:10 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
  * SHADOW (Tutorial wrapup by (dushoff)) - [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 19:10-19:30 TBD NOTE **TODO: fill hole** Model taxonomy??
...
- 19:15-19:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ((pulliam) or (reiner))
...
- 17:30-17:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ((dushoff) or (reiner))
- 17:45-17:55 **Lab 6 Summary** NOTE mentor? **TODO:** assignment
- 17:55-18:30 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
- 18:30-19:30 **Work session:** Group projects NOTE does it make sense to have these during interactive sessions? I think so...
...
- 17:30-17:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ((pearson))
- 17:45-17:55 **Lab 7 Summary** ((kassanjee))
- 17:55-18:05 **Lab 8 Summary** ((kassanjee))
- 18:05-18:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) NOTE Why I??
- 18:20-18:30 **Tutorial 5 Summary** ((dushoff))
...
- 17:45-18:00 **Summary and Discussion:** Faculty research presentation ((hargrove))
- 18:00-19:30 **Work session:** Group projects NOTE 90 mins REALLY?? **TODO** think we need at least 30 mins additional structured time...
