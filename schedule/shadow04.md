...
- 13:30-15:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) NOTE (40 + 10 group + 40)
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 13:30-14:00 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 12:10–12:30 **_Parallel sessions_** NOTE **TODO: Track assignments**
...
- 14:30-15:30 **Interactive session:** Modelling for policy (Moderators: (borchering) and (pearson))
- SHADOW 15:30-16:00 Faculty meeting
