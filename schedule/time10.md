...
- 16:55-17:05 Lab 1 Summary ((bolton)) 
...
- 17:30-18:30 **Research Pitches II** (Moderator: [Becky Borchering]({{site.subdomainurl}}/team/borchering/)) 
...
- 20:40-21:10 **Discussion:** MMED research projects ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
...
- 16:40-18:10 **Computer session:** Model fitting ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
...
- 17:15-17:30 **Organizational session:** Schedule and goals for the second week ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
- 17:30-18:15 **Computer session:** Introduction to GitHub (discussion and tutorial) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 18:15-18:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) or (reiner))
...
- 16:30-16:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/) or (reiner))
- 16:45-16:55 **Lab 6 Summary** 
- 16:55-17:30 **Tutorial review:** Q&A on all tutorials to date ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) and all)
...
- 16:30-16:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
...
- 17:05-17:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) 
- 17:20-17:30 **Tutorial 5 Summary** ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
- 17:30-18:30 **Work session:** Group projects

#### Interactive session 8b


- 19:30-20:30 **Interactive session:** Modelling for policy (Moderators: [Becky Borchering]({{site.subdomainurl}}/team/borchering/) and [Carl Pearson]({{site.subdomainurl}}/team/pearson/))
...
- 16:45-17:00 **Summary and Discussion:** Faculty research presentation ([John Hargrove]({{site.subdomainurl}}/team/hargrove/))
- 17:00-18:30 **Work session:** Group projects 
