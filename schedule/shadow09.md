...
- 18:30-20:00 **Tutorial:** Dynamical Fever - computer exercise and discussion ((pulliam), all faculty assisting) NOTE (40 + 10 group + 40)
	...
	```
- 20:00-20:30 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 15:30-16:30 **Research Pitches I** (Moderator: (dushoff)) NOTE JD willing to moderate?
...
- 16:30-17:30 **Research Pitches II** (Moderator: (borchering)) NOTE RB willing to moderate?
...
- 19:40-20:10 **Discussion:** MMED research projects ((dushoff)) NOTE 30 mins
...
- 15:40-17:10 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
  * SHADOW (Tutorial wrapup by (dushoff)) - [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 17:10-17:30 TBD NOTE **TODO: fill hole** Model taxonomy??
