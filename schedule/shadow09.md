...
- 16:40-16:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ((borchering))
...
- 15:30-16:15 **Interactive lecture:** Data, models and science ((dushoff))
...
- 17:15-17:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ((pulliam))
...
- 15:30-16:30 **Lecture:** Likelihood fitting and dynamic models II ((reiner))
- 16:30-17:00 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
...
SHADOW MC Reshma
- 18:30-19:30  **Interactive lecture:** Study design and simulation-based validation ((dushoff)
...
- 15:30-15:45 **Summary and Discussion:** Data wrangling: Data management and cleaning ((mwangi))
- 15:45-15:55 **Tutorial 5 Summary** ((dushoff))
- 15:55-17:00 **Live Lecture:** Introduction to Monte Carlo Markov Chains (MCMC) ((pearson))
- 17:00-17:30 **Work session:** Group projects
...
- 19:30-20:30 **Real-world example:** [Faculty research lecture](../talks/li) ((li))
- SHADOW 20:30-21:00 Faculty meeting
...
- 15:30-15:45 **Summary and Discussion:** Model assessment ((dushoff))
	* SHADOW Someone else!
- 15:45-15:55 **Lab 6 Summary** ((reiner))
- 15:55-16:05 Lab 7 Summary ((kassanjee))
- 16:05-16:20 **Summary and Discussion:** Faculty research presentation ((hargrove))
- 16:20-17:30  **Work session:** Group projects and One-on-one mentoring sessions (cross-time zone) NOTE 90 mins REALLY?? **TODO** think we need at least 30 mins additional structured time...

#### Interactive session 9b


- 18:30-18:40 Lab 8 Summary ((kassanjee))
- 18:40-19:30 Special topic sessions / group mentoring (TBD) NOTE **TODO** - what??? as requested by participants? or faculty / guest lecture??
