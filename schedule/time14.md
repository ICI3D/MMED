...
- 20:30-21:15 **Interactive lecture:** Data, models and science ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
...
- 22:15-22:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/))
...
- 23:30-00:30  **Interactive lecture:** Study design and simulation-based validation ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)
...
- 20:30-20:45 **Summary and Discussion:** Data wrangling: Data management and cleaning ([Thumbi Mwangi]({{site.subdomainurl}}/team/mwangi/))
...
- 00:30-01:30 **Real-world example:** [Faculty research lecture](../talks/li) ([Michael Li]({{site.subdomainurl}}/team/li/))
...
- 20:45-20:55 **Lab 6 Summary** ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))
- 20:55-21:10 **Summary and Discussion:** Faculty research presentation ([John Hargrove]({{site.subdomainurl}}/team/hargrove/))
- 21:10-22:30 **Work session:** Group projects and One-on-one mentoring sessions (cross-time zone)

#### Interactive session 9b


- 23:30-23:50 Labs 7 and 8 Summary ([Reshma Kassanjee]({{site.subdomainurl}}/team/kassanjee/))
...
- Tutorial catch-up, as needed
- Work on group project
    - **Finalize project presentations and upload to Teams (00_FinalPresentations folder) by 19:30**
- One-on-one mentoring sessions 
...
- 20:30-22:30 **Group project presentations** ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/))
