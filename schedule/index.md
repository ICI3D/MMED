...
-   10:00 – 10:30 *Coffee break*
-   10:30 – 12:20 **Computer Session:** [R Tutorials](../tutorials) - Lab 1: ODE models in R (TBA); **MedPH break-out group** ({% include instructors people="pulliam|mthombothi" %})
...
-   8:30 – 10:00  _**Parallel sessions:**_
    - **Track A:** **Lecture** and **Computer Session:** Study Design and Analysis in Epidemiology II: RCT's ({% include instructors people="kassanjee" %}) and [R Tutorials](../tutorials) - Lab 4: Study Design for Clinical Trials (TBA)
