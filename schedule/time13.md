...
- 23:40-00:10 **Discussion:** MMED research projects ([Cari van Schalkwyk]({{site.subdomainurl}}/team/vanschalkwyk/)) 
...
- 19:30-20:50 **Computer session:** Model fitting ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
	* 20:50-21:10 (Tutorial wrapup by [Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 21:10-21:30 Issues arising (mini-feedback, content in general) ([Thumbi Mwangi]({{site.subdomainurl}}/team/mwangi/))
...
- Tutorial catch-up
- [Project preferences questionnaire](https://forms.gle/LvSbCukSD7WvK49o8) [due by 15:00 on Monday]
- [Tutorial review and mentoring sessions questionnaire](https://forms.gle/S1YGWA3279s9jMrT8) [due by 22:30 on Monday]
...
- 19:30-20:15 **Interactive lecture:** Data, models and science ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
...
- 21:15-21:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/))

**Note:** Please complete the [tutorial review and mentoring sessions questionnaire](https://forms.gle/S1YGWA3279s9jMrT8) by 22:30 on Monday!
...
- 19:30-20:30 **Lecture:** Likelihood fitting and dynamic models II ([Bobby Reiner]({{site.subdomainurl}}/team/reiner/))
- 20:30-21:00 **Tutorial review:** Q&A on all tutorials to date ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) and all)
- 21:00-21:30 **Work session:** Group projects

#### Interactive session 7b


- 22:30-23:30  **Interactive lecture:** Study design and simulation-based validation ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)
...
- 19:30-19:45 **Summary and Discussion:** Data wrangling: Data management and cleaning ([Thumbi Mwangi]({{site.subdomainurl}}/team/mwangi/))
- 19:45-19:55 **Tutorial 5 Summary** ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
...
- 19:55-21:00 **Live Lecture:** Introduction to Monte Carlo Markov Chains (MCMC) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 21:00-21:30 **Work session:** Group projects
...
- 23:30-00:30 **Real-world example:** [Faculty research lecture](../talks/li) ([Michael Li]({{site.subdomainurl}}/team/li/))
...
- 22:50-00:30 **Work session:** Group projects and One-on-one mentoring sessions

#### Individual session 9

- Tutorial catch-up, as needed
- Work on group project
    - **Finalize project presentations and upload to Teams (00_FinalPresentations folder) by 18:30**
- One-on-one mentoring sessions 
...
- 19:30-21:30 **Group project presentations** ([Larisse Bolton]({{site.subdomainurl}}/team/bolton/))
