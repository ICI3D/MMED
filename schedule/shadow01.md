...
- 10:30-12:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) NOTE (40 + 10 group + 40)
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 10:30-11:00 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 07:30-08:30 **Research Pitches I** (Moderator: (dushoff)) NOTE JD willing to moderate?
...
- 09:10–09:30 **_Parallel sessions_** NOTE **TODO: Track assignments**
...
- 11:40-12:10 **Discussion:** MMED research projects ((dushoff)) NOTE 30 mins
...
- 07:40-09:10 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
  * SHADOW (Tutorial wrapup by (dushoff)) - [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 09:10-09:30 TBD NOTE **TODO: fill hole** Model taxonomy??
...
- 07:30-08:15 **Interactive lecture:** Doing Science ((dushoff))
...
- 09:15-09:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ((pulliam) or (reiner))
...
- 07:30-07:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ((dushoff) or (reiner))
- 07:45-07:55 **Lab 6 Summary** NOTE mentor? **TODO:** assignment
- 07:55-08:30 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
- 08:30-09:30 **Work session:** Group projects NOTE does it make sense to have these during interactive sessions? I think so...
...
- 07:30-07:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ((pearson))
- 07:45-07:55 **Lab 7 Summary** ((kassanjee))
- 07:55-08:05 **Lab 8 Summary** ((kassanjee))
- 08:05-08:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) NOTE Why I??
- 08:20-08:30 **Tutorial 5 Summary** ((dushoff))
...
- 11:30-12:30 **Interactive session:** Modelling for policy (Moderators: (borchering) and (pearson))
- SHADOW 12:30-13:00 Faculty meeting
...
- 07:45-08:00 **Summary and Discussion:** Faculty research presentation ((hargrove))
- 08:00-09:30 **Work session:** Group projects NOTE 90 mins REALLY?? **TODO** think we need at least 30 mins additional structured time...
