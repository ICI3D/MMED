...
- 07:30-08:30 **Lecture:** Likelihood fitting and dynamic models II ((dushoff) or (reiner))
- 08:30-09:00 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
- 09:00-09:30 **Work session:** Group projects NOTE does it make sense to have these during interactive sessions? I think so...

#### Interactive session 7b


- 10:30-11:30  **Interactive lecture:** Participatory coding of a dynamical model ((dushoff) NOTE **TODO** - what??? as requested by participants? could potentially do mcmc here since they requested live lectures???
...
- 07:30-07:45 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) NOTE Why I??
