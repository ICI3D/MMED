...
- 20:40-20:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ((borchering))
...
- 19:30-20:50 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
	...
	* 20:50-21:10 (Tutorial wrapup by (dushoff)) [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
...
- SHADOW 00:30-01:00 Faculty meeting (CANCELLED, have some fun!)
...
- 21:15-21:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ((pulliam))
...
- 19:30-20:30 **Lecture:** Likelihood fitting and dynamic models II ((reiner))
- 20:30-21:00 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
- 21:00-21:30 **Work session:** Group projects NOTE does it make sense to have these during interactive sessions? I think so...

#### Interactive session 7b


- 22:30-23:30  **Interactive lecture:** Participatory coding of a dynamical model ((dushoff) NOTE **TODO** - what??? as requested by participants? could potentially do mcmc here since they requested live lectures???
...
- 19:30-19:45 **Summary and Discussion:** Data wrangling: Data management and cleaning ((mwangi)) NOTE Used to say I, but we don't know why. Was there a II?
	* SHADOW We usually have a different summarizer than lecturer; should someone volunteer for this?
- 19:45-19:55 **Tutorial 5 Summary** ((dushoff))
- 19:55-21:00 **Live Lecture:** Introduction to Monte Carlo Markov Chains (MCMC) ((pearson)) NOTE CHECK!!!!!!
...
- 20:05-20:20 **Summary and Discussion:** Faculty research presentation ((hargrove))
- 20:20-21:30  **Work session:** Group projects and One-on-one mentoring sessions (cross-time zone) NOTE 90 mins REALLY?? **TODO** think we need at least 30 mins additional structured time...
