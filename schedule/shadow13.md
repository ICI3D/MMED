...
- 22:30-00:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) NOTE (40 + 10 group + 40)
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 22:30-23:00 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 21:10–21:30 **_Parallel sessions_** NOTE **TODO: Track assignments**
...
- 20:30-21:30 **Research Pitches II** (Moderator: (borchering)) NOTE RB willing to moderate?
...
- 23:40-00:10 **Discussion:** MMED research projects ((dushoff)) NOTE 30 mins
...
- 19:40-21:10 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
  * SHADOW (Tutorial wrapup by (dushoff)) - [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 21:10-21:30 TBD NOTE **TODO: fill hole** Model taxonomy??
