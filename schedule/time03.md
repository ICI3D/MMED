...
- 10:40-10:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
...
- 12:30-14:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 12:30-13:00 **Discussion:** Dynamical Fever ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
...
- 09:55-10:05 Lab 1 Summary ((bolton)) 
...
- 10:30-11:30 **Research Pitches II** (Moderator: [Becky Borchering]({{site.subdomainurl}}/team/borchering/)) 
...
- 13:40-14:10 **Discussion:** MMED research projects ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
...
- 09:30-09:40 Summary and Discussion: Introduction to models and data: HIV in Harare (Hargrove)
- 09:40-11:10 **Computer session:** Model fitting ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
...
- Tutorial catch-up
- Project preferences questionnaire [due by 05:00 on Monday]
...
- 09:30-10:15 **Interactive lecture:** Doing Science ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
- 10:15-10:30 **Organizational session:** Schedule and goals for the second week ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
- 10:30-11:15 **Computer session:** Introduction to GitHub (discussion and tutorial) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 11:15-11:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) or (reiner))
...
- 09:30-09:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/) or (reiner))
- 09:45-09:55 **Lab 6 Summary** 
- 09:55-10:30 **Tutorial review:** Q&A on all tutorials to date ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) and all)
- 10:30-11:30 **Work session:** Group projects 

#### Interactive session 7b


- 12:30-13:30 **Real-world example:** Faculty research lecture ((li))
...
- 09:30-09:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 09:45-09:55 **Lab 7 Summary** ([Reshma Kassanjee]({{site.subdomainurl}}/team/kassanjee/))
- 09:55-10:05 **Lab 8 Summary** ([Reshma Kassanjee]({{site.subdomainurl}}/team/kassanjee/))
- 10:05-10:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) 
- 10:20-10:30 **Tutorial 5 Summary** ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
- 10:30-11:30 **Work session:** Group projects
...
- 13:30-14:30 **Interactive session:** Modelling for policy (Moderators: [Becky Borchering]({{site.subdomainurl}}/team/borchering/) and [Carl Pearson]({{site.subdomainurl}}/team/pearson/))
...
- 09:45-10:00 **Summary and Discussion:** Faculty research presentation ([John Hargrove]({{site.subdomainurl}}/team/hargrove/))
- 10:00-11:30 **Work session:** Group projects 

#### Interactive session 9b


- 12:30-13:30 Special topic sessions / group mentoring (TBD) 
- 13:30-14:30 Special topic sessions / group mentoring (TBD) 
