...
- 08:40-08:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
...
- 10:30-12:00 **Tutorial:** Dynamical Fever - computer exercise and discussion (All faculty) 
    - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::dynamicalFever()
	```
- 10:30-11:00 **Discussion:** Dynamical Fever ([John Hargrove]({{site.subdomainurl}}/team/hargrove/)) 
...
- 07:55-08:05 Lab 1 Summary ((bolton)) 
...
- 08:30-09:30 **Research Pitches II** (Moderator: [Becky Borchering]({{site.subdomainurl}}/team/borchering/)) 
...
- 11:40-12:10 **Discussion:** MMED research projects ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/)) 
...
- 10:30-11:30 **Mentor presentations** (Moderator: (reiner)) 
...
- 08:15-08:30 **Organizational session:** Schedule and goals for the second week ([Becky Borchering]({{site.subdomainurl}}/team/borchering/))
- 08:30-09:15 **Computer session:** Introduction to GitHub (discussion and tutorial) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
- 09:15-09:30 **Summary and Discussion:**  Likelihood fitting and dynamic models, Part 1: Dynamic Model Fitting and Inference Robustness ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) or (reiner))
...
- 07:30-07:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/) or (reiner))
- 07:45-07:55 **Lab 6 Summary** 
- 07:55-08:30 **Tutorial review:** Q&A on all tutorials to date ([Juliet Pulliam]({{site.subdomainurl}}/team/pulliam/) and all)
- 08:30-09:30 **Work session:** Group projects 

#### Interactive session 7b


- 10:30-11:30 **Real-world example:** Faculty research lecture ((li))
...
- 07:30-07:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ([Carl Pearson]({{site.subdomainurl}}/team/pearson/))
...
- 08:05-08:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) 
- 08:20-08:30 **Tutorial 5 Summary** ([Jonathan Dushoff]({{site.subdomainurl}}/team/dushoff/))
- 08:30-09:30 **Work session:** Group projects

#### Interactive session 8b


- 10:30-11:30 **Real-world example:** Faculty research lecture ((hladish))
- 11:30-12:30 **Interactive session:** Modelling for policy (Moderators: [Becky Borchering]({{site.subdomainurl}}/team/borchering/) and [Carl Pearson]({{site.subdomainurl}}/team/pearson/))
...
- 07:45-08:00 **Summary and Discussion:** Faculty research presentation ([John Hargrove]({{site.subdomainurl}}/team/hargrove/))
- 08:00-09:30 **Work session:** Group projects 
