...
- 10:40-10:50 **Organizational session:** [MMED Road Map](../roadmap) and programme overview ((borchering))
...
- 12:30-14:00 **Tutorial:** Dynamical Fever - computer exercise and discussion ((pulliam), all faculty assisting) NOTE (40 + 10 group + 40)
	...
	```
- 14:00-14:30 **Discussion:** Dynamical Fever ((hargrove)) HIDE - [model description](../Materials/fever), modeling terminology, and the [DAIDD glossary](http://tinyurl.com/daidd-public) - [Download the taxonomy](../Materials/modelTaxonomy)
...
- 09:30-10:30 **Research Pitches I** (Moderator: (dushoff)) NOTE JD willing to moderate?
...
- 09:40-11:10 **Computer session:** Model fitting ((hargrove)) NOTE 90 mins - [Tutorial notes from DAIDD](http://www.ici3d.org/DAIDD/Materials/hivTutorial)
  * SHADOW (Tutorial wrapup by (dushoff)) - [Boxcar Model Slides](http://www.ici3d.org/DAIDD/Materials/boxcarModels.pdf)
  - To get started, run the following command at the R Studio command line (after installing the ICI3D package):
	```R
		ICI3D::hivTutorial()
	```
- 11:10-11:30 TBD NOTE **TODO: fill hole** Model taxonomy??
...
- 09:30-09:45 **Summary and Discussion:** Likelihood fitting and dynamic models II ((dushoff) or (reiner))
- 09:45-09:55 **Lab 6 Summary** NOTE mentor? **TODO:** assignment
- 09:55-10:30 **Tutorial review:** Q&A on all tutorials to date ((pulliam) and all)
- 10:30-11:30 **Work session:** Group projects NOTE does it make sense to have these during interactive sessions? I think so...
...
- 09:30-09:45 **Summary and Discussion:** Introduction to Monte Carlo Markov Chains (MCMC) ((pearson))
- 09:45-09:55 **Lab 7 Summary** ((kassanjee))
- 09:55-10:05 **Lab 8 Summary** ((kassanjee))
- 10:05-10:20 **Summary and Discussion:** Data wrangling I: Data management and cleaning ((mwangi)) NOTE Why I??
- 10:20-10:30 **Tutorial 5 Summary** ((dushoff))
...
- 09:45-10:00 **Summary and Discussion:** Faculty research presentation ((hargrove))
- 10:00-11:30 **Work session:** Group projects NOTE 90 mins REALLY?? **TODO** think we need at least 30 mins additional structured time...
