...
- Tutorial 0: [Introduction to R Studio](https://raw.githubusercontent.com/ICI3D/RTutorials/master/ICI3D_Tutorial_0.R) - provides an introduction to the user interface
